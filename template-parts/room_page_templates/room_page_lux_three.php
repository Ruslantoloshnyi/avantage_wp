<?php
$image = get_sub_field('room_page_lux_three_image');
$content = get_sub_field('room_page_lux_three_content');
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-12 rooms-card">
                ...
                <div class="container-card">
                    ...
                    <div class="rooms-card-head">Люкс для трьох</div>

                    <div class="rooms-card-pinc">

                        <?php while (have_rows('room_page_lux_three_pic')) : the_row();
                            $image_pic = get_sub_field('lux_three_pic');
