<?php
$image = get_sub_field('room_page_comfort_two_image');
$content = get_sub_field('room_page_comfort_two_content');
...
<?php if (have_rows('room_page_comfort_two_pic')) : ?>
    ...
    <div class="col-md-6 col-12 rooms-card">
        ...
        <div class="container-card">
            ...
            <div class="rooms-card-head">Комфорт для двох</div>

            <div class="rooms-card-pinc">

                <?php while (have_rows('room_page_comfort_two_pic')) : the_row();
                    $image_pic = get_sub_field('comfort_two_pic');
